...
| `setPreviousActivity(activity)`              | Stores the previous activity before the notification was triggered.   |
| `getPreviousActivity()`                      | Retrieves the stored previous activity.                               |
| `resumePreviousActivity()`                   | Resumes the stored previous activity after the notification ends.     |
